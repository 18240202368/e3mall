    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://192.168.1.21:8088/page/login/">请登录</a>
      	</span>
      	<!-- https://passport.e3mall.cn/reg/?returnUrl=http%3A//www.e3mall.cn/ -->
      	<a href="http://192.168.1.21:8088/page/register">免费注册</a>
      </li>
